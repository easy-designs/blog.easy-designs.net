...
{assign_variable:this_url="<?php echo urlencode( 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ); ?>"}
				...
				<section id="bookmark">
					...
					<p class="google_plus"><a href="https://plusone.google.com/_/+1/confirm?hl=en&amp;url={this_url}&amp;referer={this_url}"><img src="{css_images}/button-googleplus-enabled.png" alt="Share on Google Plus"/></a></p>
	            </section>