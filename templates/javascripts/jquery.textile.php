(function(){
  jQuery.textile = function( s )
  {
    var r = s, ttag, htag, re, nr, lines, line, changed, inlist, listtype;
    ...
    qtags = [['\\*', 'strong'],
             ...
             ['\\^', 'sup'],
             ['@', 'code']];
    for ( var i=0, qLen=qtags.length; i<qLen; i++ )
    {
      ttag = qtags[i][0];
      htag = qtags[i][1];
    ...
    // block level formatting
		...
		// show single line breaks as they should.
